  ...
  jQuery.fn.extend({
    elastic: function() {
      ...
      return this.each(function() {
        ...
        if (this.className.indexOf('_elastic') != -1) {
          return false;
        }
        ...
        var $textarea = jQuery(this),
          ...
          minheight = parseInt($textarea.css('height'), 10) || 28, // lineHeight * 3,
        ...
        // Thêm class "elastic" vào textarea để biết cái nào có jquery elastic rồi
        $textarea.addClass('_elastic');
