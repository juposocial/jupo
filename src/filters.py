...
EMOTICONS = {
 '#-o': '<img src="/public/images/emoticons/40.gif" alt="d\'oh">',
 '#:-S': '<img src="/public/images/emoticons/18.gif" alt="whew!">',
 '>-)': '<img src="/public/images/emoticons/61.gif" alt="alien">',
 '>:)': '<img src="/public/images/emoticons/19.gif" alt="devil">',
 '>:D<': '<img src="/public/images/emoticons/6.gif" alt="big hug">',
 '>:P': '<img src="/public/images/emoticons/47.gif" alt="phbbbbt">',
 '<):)': '<img src="/public/images/emoticons/48.gif" alt="cowboy">',
 '<:-P': '<img src="/public/images/emoticons/36.gif" alt="party">',
 '<:o)': '<img src="/public/images/emoticons/36.gif" alt="party">',
 '(%)': '<img src="/public/images/emoticons/75.gif" alt="yin yang">',
 '(*)': '<img src="/public/images/emoticons/79.gif" alt="star">',
 '(:|': '<img src="/public/images/emoticons/37.gif" alt="yawn">',
 '**==': '<img src="/public/images/emoticons/55.gif" alt="flag">',
 '/:)': '<img src="/public/images/emoticons/23.gif" alt="raised eyebrows">',
 '8->': '<img src="/public/images/emoticons/105.gif" alt="day dreaming">',
 '8-X': '<img src="/public/images/emoticons/59.gif" alt="skull">',
# '8-|': '<img src="/public/images/emoticons/29.gif" alt="rolling eyes">',  # duplicate with nerd
 '8-)': '<img src="/public/images/emoticons/29.gif" alt="rolling eyes">',
 '8-}': '<img src="/public/images/emoticons/35.gif" alt="silly">',
 ':!!': '<img src="/public/images/emoticons/110.gif" alt="hurry up!">',
 ':">': '<img src="/public/images/emoticons/9.gif" alt="blushing">',
 ':>': '<img src="/public/images/emoticons/15.gif" alt="smug">',
 ':(': '<img src="/public/images/emoticons/2.gif" alt="sad">',
 ':-(': '<img src="/public/images/emoticons/2.gif" alt="sad">',
 ':((': '<img src="/public/images/emoticons/20.gif" alt="crying">',
 ":'(": '<img src="/public/images/emoticons/20.gif" alt="crying">',
 ':(|)': '<img src="/public/images/emoticons/51.gif" alt="monkey">',
 ':)': '<img src="/public/images/emoticons/1.gif" alt="happy">',
 ':-)': '<img src="/public/images/emoticons/1.gif" alt="happy">',
 ':)>-': '<img src="/public/images/emoticons/67.gif" alt="peace sign">',
 ':))': '<img src="/public/images/emoticons/21.gif" alt="laughing">',
 ':)]': '<img src="/public/images/emoticons/100.gif" alt="on the phone">',
 ':-"': '<img src="/public/images/emoticons/65.gif" alt="whistling">',
 ':-$': '<img src="/public/images/emoticons/32.gif" alt="don\'t tell anyone">',
 ':$': '<img src="/public/images/emoticons/32.gif" alt="don\'t tell anyone">',
 ':-#': '<img src="/public/images/emoticons/32.gif" alt="don\'t tell anyone">',
 ':-&': '<img src="/public/images/emoticons/31.gif" alt="sick">',
 ':-<': '<img src="/public/images/emoticons/46.gif" alt="sigh">',
 ':-*': '<img src="/public/images/emoticons/11.gif" alt="kiss">',
 ':-/': '<img src="/public/images/emoticons/7.gif" alt="confused">',
 ':-?': '<img src="/public/images/emoticons/39.gif" alt="thinking">',
 '*-)': '<img src="/public/images/emoticons/39.gif" alt="thinking">',
 ':-??': '<img src="/public/images/emoticons/106.gif" alt="I don\'t know">',
 ':^)': '<img src="/public/images/emoticons/106.gif" alt="I don\'t know">',
 ':-B': '<img src="/public/images/emoticons/26.gif" alt="nerd">',
 '8-|': '<img src="/public/images/emoticons/26.gif" alt="nerd">',
 ':-O': '<img src="/public/images/emoticons/13.gif" alt="surprise">',
 ':o': '<img src="/public/images/emoticons/13.gif" alt="surprise">',
 ':-SS': '<img src="/public/images/emoticons/42.gif" alt="nail biting">',
 ':-ss': '<img src="/public/images/emoticons/42.gif" alt="nail biting">',
 ':-S': '<img src="/public/images/emoticons/17.gif" alt="worried">',
 ':-s': '<img src="/public/images/emoticons/17.gif" alt="worried">',
 ':s': '<img src="/public/images/emoticons/17.gif" alt="worried">',
 ':-bd': '<img src="/public/images/emoticons/113.gif" alt="thumbs up">',
 ':-c': '<img src="/public/images/emoticons/101.gif" alt="call me">',
 ':-h': '<img src="/public/images/emoticons/103.gif" alt="wave">',
 ':-q': '<img src="/public/images/emoticons/112.gif" alt="thumbs down">',
 ':-t': '<img src="/public/images/emoticons/104.gif" alt="time out">',
 ':-w': '<img src="/public/images/emoticons/45.gif" alt="waiting">',
 ':@)': '<img src="/public/images/emoticons/49.gif" alt="pig">',
 ':D': '<img src="/public/images/emoticons/4.gif" alt="big grin">',
 ':-D': '<img src="/public/images/emoticons/4.gif" alt="big grin">',
 ':d': '<img src="/public/images/emoticons/4.gif" alt="big grin">',
 ':O)': '<img src="/public/images/emoticons/34.gif" alt="clown">',
 ':P': '<img src="/public/images/emoticons/10.gif" alt="tongue">',
 ':p': '<img src="/public/images/emoticons/10.gif" alt="tongue">',
 ':-P': '<img src="/public/images/emoticons/10.gif" alt="tongue">',
 ':^o': '<img src="/public/images/emoticons/44.gif" alt="liar">',
 ':ar!': '<img src="/public/images/emoticons/pirate_2.gif" alt="pirate">',
 ':x': '<img src="/public/images/emoticons/8.gif" alt="love struck">',
# '<3': '<img src="/public/images/emoticons/8.gif" alt="love struck">',
 ':|': '<img src="/public/images/emoticons/22.gif" alt="straight face">',
 ':-|': '<img src="/public/images/emoticons/22.gif" alt="straight face">',
 ';)': '<img src="/public/images/emoticons/3.gif" alt="winking">',
 ';-)': '<img src="/public/images/emoticons/3.gif" alt="winking">',
 ';))': '<img src="/public/images/emoticons/71.gif" alt="hee hee">',
 ';;)': '<img src="/public/images/emoticons/5.gif" alt="batting eyelashes">',
 '=((': '<img src="/public/images/emoticons/12.gif" alt="broken heart">',
 '=))': '<img src="/public/images/emoticons/24.gif" alt="rolling on the floor">',
 '=;': '<img src="/public/images/emoticons/27.gif" alt="talk to the hand">',
 '=D>': '<img src="/public/images/emoticons/41.gif" alt="applause">',
 '=P~': '<img src="/public/images/emoticons/38.gif" alt="drooling">',
 '@-)': '<img src="/public/images/emoticons/43.gif" alt="hypnotized">',
 '@};-': '<img src="/public/images/emoticons/53.gif" alt="rose">',
 'B-)': '<img src="/public/images/emoticons/16.gif" alt="cool">',
 'I-)': '<img src="/public/images/emoticons/28.gif" alt="sleepy">',
 '|-)': '<img src="/public/images/emoticons/28.gif" alt="sleepy">',
 'L-)': '<img src="/public/images/emoticons/30.gif" alt="loser">',
 'O:-)': '<img src="/public/images/emoticons/25.gif" alt="angel">',
 'X(': '<img src="/public/images/emoticons/14.gif" alt="angry">',
 ':@': '<img src="/public/images/emoticons/14.gif" alt="angry">',
 ':-@': '<img src="/public/images/emoticons/14.gif" alt="angry">',
 'X_X': '<img src="/public/images/emoticons/109.gif" alt="I don\'t want to see">',
 '[-(': '<img src="/public/images/emoticons/33.gif" alt="no talking">',
 '[-O<': '<img src="/public/images/emoticons/63.gif" alt="praying">',
 '[..]': '<img src="/public/images/emoticons/transformer.gif" alt="transformer*">',
 '\\:D/': '<img src="/public/images/emoticons/69.gif" alt="dancing">',
 '\\m/': '<img src="/public/images/emoticons/111.gif" alt="rock on!">',
 '^#(^': '<img src="/public/images/emoticons/114.gif" alt="it wasn\'t me">',
 '^:)^': '<img src="/public/images/emoticons/77.gif" alt="not worthy">',
 'o=>': '<img src="/public/images/emoticons/73.gif" alt="billy">',
 '~O)': '<img src="/public/images/emoticons/57.gif" alt="coffee">',
 '~X(': '<img src="/public/images/emoticons/102.gif" alt="at wits\' end">',
 ':-L': '<img src="/public/images/emoticons/62.gif" alt="frustrated">',
 
 '(y)': '<img src="/public/images/emoticons/thumbs-up.png" alt="thumbs up">'
